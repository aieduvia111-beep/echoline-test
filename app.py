...
<style>
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .main{flex:1;padding:40px 36px;max-width:1080px;}
  .center-head{text-align:center;margin-bottom:8px;}
  .center-head h1{font-size:30px;font-weight:800;letter-spacing:-0.01em;margin-bottom:8px;}
  .center-head p{font-size:14.5px;color:#888;}

  .toggle-wrap{display:flex;justify-content:center;margin:26px 0 36px;}
  .toggle{display:flex;background:#f2f2f4;border-radius:100px;padding:4px;}
  .toggle button{padding:9px 20px;border-radius:100px;border:none;background:transparent;font-size:13.5px;font-weight:600;color:#888;cursor:pointer;}
  ...
  .plan-card{border:1.5px solid #eee;border-radius:20px;padding:28px 26px;position:relative;display:flex;flex-direction:column;}
  .plan-card.featured{border-color:#7c6aff;box-shadow:0 20px 50px -20px rgba(124,106,255,0.35);}
  .plan-badge{position:absolute;top:-12px;left:50%;transform:translateX(-50%);background:linear-gradient(135deg,#7c6aff,#5dadff);color:#fff;font-size:10.5px;font-weight:800;letter-spacing:0.04em;padding:6px 16px;border-radius:100px;white-space:nowrap;}
  ...
  .plan-btn{width:100%;padding:13px;border-radius:11px;font-weight:700;font-size:14px;cursor:pointer;text-align:center;}
