...
<div class="main">
  <div class="lang-switch-top" style="display:flex;justify-content:flex-end;gap:4px;margin:16px 32px 0;">
    <button id="langPl" onclick="setLang('pl')" style="padding:4px 10px;border-radius:100px;border:1px solid #eee;background:#fff;font-size:11px;font-weight:700;color:#999;cursor:pointer;">PL</button>
    <button id="langEn" onclick="setLang('en')" style="padding:4px 10px;border-radius:100px;border:1px solid #eee;background:#fff;font-size:11px;font-weight:700;color:#999;cursor:pointer;">EN</button>
  </div>
