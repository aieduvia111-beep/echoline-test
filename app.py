...
<style>
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .main{flex:1;padding:36px;max-width:1100px;}
  .head{display:flex;justify-content:space-between;align-items:flex-end;margin-bottom:26px;flex-wrap:wrap;gap:12px;}
  ...
  .stat-card{border:1px solid #eee;border-radius:14px;padding:18px 20px;}
  ...
  .filter-btn{padding:8px 16px;border-radius:100px;border:1px solid #eee;background:#fff;font-size:12.5px;font-weight:600;color:#666;cursor:pointer;}
  .filter-btn.active{background:#111;color:#fff;border-color:#111;}

  .calls-table{border:1px solid #eee;border-radius:16px;overflow:hidden;}
  table{width:100%;border-collapse:collapse;}
  ...
  .empty-icon{width:70px;height:70px;border-radius:50%;background:#f5f3ff;display:flex;align-items:center;justify-content:center;margin:0 auto 18px;}
...
<div class="main rise">
  ...
  <div class="stat-row">
    <div class="stat-card"><div class="lbl">Rozmowy w tym miesiącu</div><div class="val">{{ calls|length }}</div></div>
    <div class="stat-card"><div class="lbl">Zakończone pomyślnie</div><div class="val">{{ calls|length }}</div></div>
    <div class="stat-card"><div class="lbl">Nieodebrane</div><div class="val">0</div></div>
  </div>

  <div class="filters">
    <button class="filter-btn active">Wszystkie</button>
    <button class="filter-btn">Przychodzące</button>
    <button class="filter-btn">Zadzwoń za mnie</button>
    <button class="filter-btn">Nieodebrane</button>
  </div>
