...
<div class="main rise">
  ...
  <div class="plans rise3">
    ...
    <div class="plan-card">
      ...
      <button class="plan-btn outline" onclick="choosePlan('firma')">Porozmawiajmy</button>
    </div>
  </div>
...
<script>
  ...
  function choosePlan(plan){
    ...
    msg.textContent = 'Platnosci Stripe zostana podlaczone wkrotce. Wybrany plan: ' + plan + ' (' + billing + ')';
  }
</script>
<script src="https://unpkg.com/lucide@latest/dist/umd/lucide.js"></script>
<script>lucide.createIcons();</script>
...
<style>
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .card{background:#fff;border:1px solid #eee;border-radius:16px;padding:24px;margin-bottom:18px;position:relative;z-index:1;}
  .card-head{display:flex;align-items:center;gap:9px;margin-bottom:18px;}
  .card-head svg{width:16px;height:16px;stroke:#7c6aff;fill:none;stroke-width:1.8;}
  .card-head h3{font-size:14.5px;font-weight:700;}

  .profile-row{display:flex;align-items:center;gap:16px;margin-bottom:6px;}
  .avatar-lg{width:56px;height:56px;border-radius:50%;background:linear-gradient(135deg,#7c6aff,#4f3fcf);color:#fff;display:flex;align-items:center;justify-content:center;font-size:22px;font-weight:700;flex-shrink:0;}
  ...
  .plan-banner{display:flex;justify-content:space-between;align-items:center;background:linear-gradient(135deg,#f8f7ff,#eef6ff);border-radius:12px;padding:16px 18px;}
  .plan-banner b{font-size:15px;display:block;}
  .plan-banner span{font-size:12px;color:#888;}
  .plan-banner a{font-size:12.5px;font-weight:700;color:#fff;background:linear-gradient(135deg,#7c6aff,#5dadff);padding:9px 18px;border-radius:10px;text-decoration:none;white-space:nowrap;}

  .btn-outline{padding:10px 18px;border-radius:10px;border:1.5px solid #ddd;background:#fff;font-weight:600;font-size:13px;cursor:pointer;color:#333;}
  ...
  .danger-zone{border-color:#fde3e3;}
...
<div class="main rise">
  ...
  <div class="card rise2">
    <div class="card-head"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"/><path d="M12 8v4l3 2"/></svg><h3>Profil</h3></div>
  ...
  <div class="card rise3">
    <div class="card-head"><svg viewBox="0 0 24 24"><rect x="1" y="4" width="22" height="16" rx="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg><h3>Subskrypcja</h3></div>
  ...
  <div class="card rise3">
    <div class="card-head"><svg viewBox="0 0 24 24"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg><h3>Bezpieczeństwo</h3></div>
    <div class="field-row">
  ...
  <div class="card danger-zone rise4">
    <div class="card-head"><svg viewBox="0 0 24 24" stroke="#c0392b"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg><h3 style="color:#c0392b;">Strefa zagrożenia</h3></div>
