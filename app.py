...
<style>
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .tabbtn{display:flex;align-items:center;gap:10px;padding:12px 18px;border-radius:13px;border:1px solid #eee;background:#fff;cursor:pointer;transition:all .15s;}
  ...
  <div class="content">
    ...
    <div id="section-assistant">
      <div class="cards rise3">
        ...
        <div class="action-card" onclick="document.getElementById('voice-card').scrollIntoView({behavior:'smooth',block:'center'});">
      ...
      <div class="grid2 rise4">
        <div class="card" id="voice-card">
          ...
          <div id="waveWrap" style="display:none;flex-direction:column;align-items:center;gap:12px;margin-bottom:16px;padding:28px 16px;background:linear-gradient(180deg,#f2f8ff,#fafafa);border-radius:16px;">
            <canvas id="waveCanvas" width="160" height="160"></canvas>
          ...
          <button class="save-inline" id="recordBtn" onclick="toggleRecording()">Nagraj próbkę głosu</button>
