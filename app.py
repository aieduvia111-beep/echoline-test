...
<style>
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .avatar{width:30px;height:30px;border-radius:50%;background:#111;color:#fff;display:flex;align-items:center;justify-content:center;font-size:13px;font-weight:700;flex-shrink:0;}
  ...
  .action-card .icon-box{width:100%;height:64px;background:#fafafa;border-radius:10px;margin-bottom:14px;display:flex;align-items:center;justify-content:center;}
  .action-card .icon-box svg{width:26px;height:26px;stroke:#111;fill:none;stroke-width:1.6;}
  ...
  <div class="content">
    ...
    <div class="cards">
      <div class="action-card">
        <div class="icon-box"><svg viewBox="0 0 24 24"><path d="M22 16.9v3a2 2 0 0 1-2.2 2 19.8 19.8 0 0 1-8.6-3.1 19.5 19.5 0 0 1-6-6 19.8 19.8 0 0 1-3.1-8.6A2 2 0 0 1 4.1 2h3a2 2 0 0 1 2 1.7c.1 1 .3 2 .6 3a2 2 0 0 1-.5 2.1L8 10a16 16 0 0 0 6 6l1.2-1.2a2 2 0 0 1 2.1-.5c1 .3 2 .5 3 .6a2 2 0 0 1 1.7 2z"/></svg></div>
      ...
      <div class="action-card">
        <div class="icon-box"><svg viewBox="0 0 24 24"><path d="M21 11.5a8.4 8.4 0 0 1-9 8.5 8.7 8.7 0 0 1-4-1L3 20l1-4a8.4 8.4 0 0 1-1-4 8.4 8.4 0 0 1 9-8.5 8.5 8.5 0 0 1 9 8.5z"/></svg></div>
